...
App.prototype.addArticle = function(projectId, url, title) {
  var id = uuid.v1();
  this.connections.queue.publish(SCRAPE_QUEUE, { id: id, url: url, userId: projectId, title: title });
...
App.prototype.listArticles = function(projectId, n, fresh) {
  return this.Article.list(projectId, n, fresh);
};
